...
object Util {
    ...
    fun toast(text: String, duration: Int = Toast.LENGTH_SHORT) {
        ThreadManager.runOnUi { Toast.makeText(BudgetApplication.instance, text, duration).show() }
    }

    fun toast(recId: Int, duration: Int = Toast.LENGTH_SHORT) {
        val text = BudgetApplication.instance.resources.getString(recId)
