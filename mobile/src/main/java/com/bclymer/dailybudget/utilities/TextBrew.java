package com.bclymer.dailybudget.utilities;//fsm stands for fuzzy string matching
...
public class TextBrew {
    ...
    public BrewResult computeSimilarity(String left, String right) {
        ...
        while (true) {
            ...
            if (curr.tracebackY >= matrix.length || curr.tracebackX >= matrix[curr.tracebackY].length) {
                break;
            }
