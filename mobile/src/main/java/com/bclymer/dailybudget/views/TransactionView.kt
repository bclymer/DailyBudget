    ...
    companion object {
        ...
        fun createTransactionView(inflater: LayoutInflater, recycledView: TransactionView?, parent: ViewGroup, transaction: Transaction): TransactionView {
            ...
            if (recycledView == null) {
                recycledView = inflater.inflate(R.layout.list_item_transaction, parent, false) as TransactionView
                holder = ViewHolder()
                holder.date = recycledView.findViewById(R.id.list_item_transaction_textview_date) as TextView
                holder.amount = recycledView.findViewById(R.id.list_item_transaction_textview_amount) as TextView
                holder.amountOther = recycledView.findViewById(R.id.list_item_transaction_textview_amount_other) as TextView
                holder.notes = recycledView.findViewById(R.id.list_item_transaction_textview_notes) as TextView
                holder.paidForSomeone = recycledView.findViewById(R.id.list_item_transaction_textview_paidforsomeone) as TextView
            ...
            if (TextUtils.isEmpty(transaction.location)) {
                ...
                holder.amountOther?.visibility = View.GONE
            } else {
